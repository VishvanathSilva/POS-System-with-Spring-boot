...
///////////////////////////////////////////////Load all Customers///////////////////////////////////
function loadAllCustomers() {////////build a jason
    ...
    $.ajax(ajaxConfig).done(function (customers) { //response function
...
function attachDeleteCustomerEventListener() {
    ...
    $("#tblCustomers tbody tr:last-child i").click(function () {
        var id = ($(this).parents("tr").find("td:first-child").text());//parseInt
